        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <?php 
               ...
               $result = $mysqli->query("select * from students") or die(mysqli_error($mysqli));
              ?>
            <tr>
            ...
            <tr>
              ...
              <td><a href="details_student.php?student_id=<?php echo $row['id']; ?>"><?php echo $row['name']; ?> <?php echo $row['surname']; ?></td>
              <?php 
              $query4="SELECT * FROM groups where id=". $row['group_id'];
