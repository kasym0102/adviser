...
<br><br>
      ...
      <h2>EDIT PERFORMANCE OF STUDENTS</h2>
      <br>
      <br>
      <?php 
        ...
        <form class="mt-3" action="process.php" method="post">
          <div class="form-group">
            ...
            <input type="hidden" name="course_id" value="<?php echo $course_id ?>">
              ...
              <input type="text" name="rk1"  class="form-control" placeholder="RK1">
          </div>
          <div class="form-group">
              <input type="text" name="rk2" id="rk2" class="form-control"  placeholder="RK2" >
          </div>
          <div class="form-group">
              <input type="text" name="attendance" id="attendance" class="form-control" placeholder="attendance" >
          </div>
          <div class="form-group">
              <input type="text" name="final" id="final" class="form-control" placeholder="final" >
          </div>
          <div class="form-group">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" name="editPerformance" class="btn btn-primary">ADD</button>
          </div>
        </form>
