        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
              <?php 
               ...
               $result1 = $mysqli->query("select * from groups") or die(mysqli_error($mysqli));
              ?>
            <tr>
            ...
            <tr>
              ...
              <td><a href="details_group.php?group_id=<?php echo $row1['id']; ?>"><?php echo $row1['name']; ?></td>


              <?php 
               $result8 = mysqli_query($mysqli, "SELECT * FROM students WHERE group_id =". $row1['id']); 
              ...
              <?php 
              $query4="SELECT * FROM adviser where adviser_id=". $row1['adviser_id'];
              $req4=mysqli_query($mysqli, $query4);
              $result4 = mysqli_fetch_assoc($req4);
 
          ?>
              <td><?php echo $result4['adviser_name']; ?>  <?php echo $result4['adviser_surname']; ?></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="mt-3" action="process.php" method="post">
                          <div class="form-group">
                            ...
                            ?>
                              <input type="text" name="group_name" id="group_name" class="form-control" value="" placeholder="Group name...">
                          </div>
                           <div class="form-group">
                            <label for="select_adviser">ADVISER:</label>
                              <select id="select_adviser" name="adviser_id" class="form-control">
                                <?php  
                                    while ($row = $result->fetch_assoc()):?>
                                    <option value="<?php echo $row['adviser_id']; ?>"> <?php echo $row['adviser_name']; ?> <?php echo $row['adviser_surname']; ?></option>
                                <?php endwhile; ?>
                                </select>
                          </div>
                          <div class="form-group">
                            <label for="select_dep">Department:</label>
                              <select id="select_dep" name="department_name" class="form-control">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="addGroup" class="btn btn-primary">ADD</button>
       </form>
