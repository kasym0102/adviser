      ...
      <div class="col-10">
        ...
        <div class="card float-left" style="width: 18rem;">
          <div class="card-body">
            ...
            <p class="card-text">Department: <?php echo $result['department']; ?></p>
         

            <p class="card-text">Number of students: 1 </p>

            <?php 
              $query1="SELECT * FROM adviser where adviser_id=". $result['adviser_id'];
              $req1=mysqli_query($mysqli, $query1);
              $result1 = mysqli_fetch_assoc($req1);
 
          ?>
            <p class="card-text">Adviser: <a href="details_adviser.php?adviserdetails=<?php echo $result1['adviser_id'];; ?>"><?php echo $result1['adviser_name']; ?>  <?php echo $result1['adviser_surname']; ?></a></p>
...
<!--dfdsfdsfsdffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff-->
       ...
       $result4 = $mysqli->query("select * from students where group_id=". $group_id) or die(mysqli_error($mysqli));
         ...
         <div class="float-left ml-5" style="width: 70%">      
            <h2>LIST OF STUDENTS OF <?php echo $result['name']; ?>
            </h2>

                  <button class="btn btn-success float-left" data-toggle="modal" data-target="#exampleModal1">+ ADD NEW</button>
            <br><br>
                ...
                <tbody>
                     <?php  
                      ...
                      <tr>
                        ...
                        <td><a href="details_student.php?student_id=<?php echo $row1['id']; ?>"><?php echo $row1['name']; ?> <?php echo $row1['surname']; ?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="mt-3" action="process.php" method="post">
                            <input type="hidden" name="group_id" value="<?php echo $result['id']; ?>">

                          <div class="form-group">
                              <input type="text" name="group_name" id="name" class="form-control" value="<?php echo $result['name']; ?>" placeholder="Group name..." autocomplete="username">
                          </div>
                           <div class="form-group">
                            <label for="select_adviser">ADVISER:</label>

                             <?php 
                             $result5 = $mysqli->query("select * from adviser") or die(mysqli_error($mysqli));
                                    
                                ?>
                              <select id="adviser_id" name="adviser_id" class="form-control">

                                <?php  
                                  while ($row2 = $result5->fetch_assoc()):
                                    ?>
                                    <option value="<?php echo $row2['adviser_id'] ?>"> <?php echo $row2['adviser_name']; ?> <?php echo $row2['adviser_surname']; ?></option>
                          ...
                          <div class="form-group">
                            <label for="select_dep">Department:</label>
                              <select id="select_dep" class="form-control" name="department_name">
                                <option>CIES</option>
                                <option>MCM</option>
                                <option>IS</option>
                                <option>EB</option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name = "update_group" class="btn btn-primary">Edit</button>
       </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="mt-3" action="process.php" method="post">
                          ...
                          <div class="form-group">
                              <input type="text" name="login" id="username" class="form-control" placeholder="Логин" >
                          </div>
                          <div class="form-group">
                              <input type="password" name="password" id="password" class="form-control" placeholder="Пароль" >
                          </div>
                          <div class="form-group">
                              <input type="password" name="re_password" id="re_password" class="form-control" placeholder="Повторите пароль">
                          </div>
                          <div class="form-group">
                              <input type="text" name="picture_url"class="form-control" placeholder="Link to photo...">
                          </div>
                          <div class="form-group">
                          ...
                          <input type="hidden" value="<?php echo $result['id']; ?>" name="group_id"></input>                                            
                        </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="addStudent1" class="btn btn-primary">ADD</button>
       </form>
